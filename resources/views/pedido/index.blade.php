                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @if (count($registros) <= 0)
                                        <tr>
                                            <td colspan="7">No hay registros que coincidan con la busqueda</td>
                                        </tr>
                                    @else
                                        @foreach ( $registros as $reg )
                                            <tr class="align-middle">
                                                <td>
                                                    <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#modal-estado-{{ $reg->id }}"><i class="bi bi bi-arrow-repeat"></i>
                                                    </button>
                                                </td>
                                                <td>{{ $reg->id }}</td>
                                                <td>
                                                    ...
                                                    <table class="table table-sm table-striped">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <img src="{{ asset('uploads/productos/' . $detalle->producto->imagen) }}" alt="{{ $detalle->producto->nombre }}" class="img-fluid rounded" style="width: 80px; height: 80px; object-fit: cover;">
                                                                </td>
                                                                <td>{{ $detalle->producto->cantidad }}</td>
