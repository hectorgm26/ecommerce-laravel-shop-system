                ...
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex">
                            ...
                            {{-- Campo oculto para enviar el ID del producto al carrito --}}
                            <input type="hidden" name="id" value="{{ $producto->id }}" />

                            <input class="form-control text-center me-3" id="inputQuantity" name="cantidad" type="number" min="1"
                            ...
                            <a class="btn btn-outline-secondary ms-2" href="javascript:history.back()">
                                Volver atrás
                            </a>
