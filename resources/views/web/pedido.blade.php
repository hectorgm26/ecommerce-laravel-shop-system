                ...
                <div class="col-lg-8">
                    <div class="card mb-4">
                        ...
                        <div class="card-body" id="cartItems">
                            ...
                            {{-- Se recorre el carrito objeto por objeto con el id del producto, y se guardan en un $item --}}
                            @forelse($carrito as $id => $item)

                            <!-- Product  -->
                            <div class="row align-items-center mb-3 cart-item">
                                {{-- NOMBRE, IMAGEN Y CODIGO --}}
                                ...
                                <div class="col-md-2 d-flex justify-content-center">
                                    <div class="input-group input-group-sm" style="max-width: 100px;">
                                            ...
                                            <a class="btn btn-outline-secondary" data-action="decrease" href="{{ route('carrito.restar', ['producto_id' => $id]) }}">-</a>

                                            <input type="text" class="form-control text-center" value="{{ $item['cantidad'] }}"
                                                readonly>

                                            <a href="{{ route('carrito.sumar', ['producto_id' => $id]) }}"class="btn btn-outline-secondary btn-sm" data-action="increase">+</a>
                                ...
                                <div class="col-md-3 d-flex align-items-center justify-content-end">
                                    <div class="text-end me-3">
                                        <span class="fw-bold subtotal">{{ number_format($item['precio'] * $item['cantidad'], 2) }}
                                        </span>
                                    </div>
                        ...
                        @if(session('error'))
                            <div class="alert alert-dangger alert-dismissible fade show mt-3" role="alert">
                                {{ session('error') }}
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                            </div>
                        @endif
