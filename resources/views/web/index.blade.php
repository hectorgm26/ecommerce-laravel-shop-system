...
@section('header')
    {{-- PARA MOSTRAR EL HEADER DE LA TIENDA CON EL CARRUSEL, YA QUE EN CARRITO Y DESCRIPCION DEL PEDIDO NO SE MUESTRA ESTE --}}
@endsection
    ...
    <section class="py-5">
        <div class="container px-4 px-lg-5 mt-1">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto"
                                        href="{{ route('web.show', $producto->id) }}">Ver producto</a></div>
                            </div>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="card-footer clearfix">
                {{-- PARA MOSTRAR LA PAGINACION CON LA BUSQUEDA --}}
                {{ $productos->appends([
